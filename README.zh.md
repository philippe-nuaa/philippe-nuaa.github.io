...
```
# Site settings
title: HuliangBlog             # 你的博客网站标题
SEOTitle: HuliangBlog			# 在后面会详细谈到
...
sidebar-avatar: /img/avatar-huliang.png     #你的大头贴，请使用绝对地址.
```
...
我的博客标题是 **“HuliangBlog”** 但是我想要在搜索的时候显示 **“黄玄的博客 | HuliangBlog”** ，这个就需要SEO Title来定义了。
